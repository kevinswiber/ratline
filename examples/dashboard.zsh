#!/usr/bin/env zsh
# A live system dashboard in plain zsh. Run it, watch it repaint
# flicker-free, ctrl-c to leave. `./dashboard.zsh --once` prints one frame.
set -euo pipefail
